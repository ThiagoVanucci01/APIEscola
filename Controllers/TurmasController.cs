...
namespace APIEscola.Controllers
{
    ...
    public class TurmasController : ControllerBase
    {
        ...
        // GET: api/Turmas/5  // busca uma turma pelo id
        [HttpGet("{id}")]
        ...
        // PUT: api/Turmas/5 // Atualiza uma turma pelo id
        ...
        // POST: api/Turmas // posta uma turma
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        ...
        // DELETE: api/Turmas/5 // deleta uma turma pelo id
        [HttpDelete("{id}")]
